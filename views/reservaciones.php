...
<body class="">
    ...
    <div class="container">
        <form method="POST" action="http://143.244.172.240/hotel_sureste/models/reservar.php">
            <br>
            <div class="row">
                <!-- Dato habitacional -->
                        ...
                        <?php
                            ...
                            if($llave){
                               ...
                               echo "<div class=\"col-md-2\">
                                ...
                                echo "<input type=\"password\"  name=\"tarjeta\" class=\"form-control\" placeholder=\"16 digitos\" id=\"input_tarjeta\" maxlength=\"16\" pattern=\"[16-16]\" required>
